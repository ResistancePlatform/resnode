...
console.log(resistancecfg)

if (resistancecfg.testnet) {
  console.log('Resistance is running on testnet')
  console.log('To run on mainnet please reconfigure resistance.conf and remove or comment \'#testnet=1\'')
